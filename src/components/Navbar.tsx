...
import {Icon } from "@ui";
// 컴포넌트의 props나 데이터 구조의 타입을 정의하는 역할
// 컴포넌트에 전달되는 props가 어떤 데이터 형식을 가지는지 명확히 할 수 있음
interface NavbarProps {
	// 컴포넌트에 전달되는 props의 구조와 필수/옵션 항목을 정의
	// props가 어떤걸 기대하는지 명확히 알 수 있음
	menuItems: MenuItem[];
	// menuItems를 객체로 가지는 배열로 초기화
}
