...
import TheSearchBar from "../ui/TheSearchBar";
		...
		<>
			...
			>
				<div className="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
					<TheSearchBar
						elementID="sidebar-search"
						placeHolder="Search"
						searchClass="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
					/>
						...
						<li>
							...
							>
								<Icon
									...
									pathProps={[
										{
											direction: "M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z",
										},
										{
											direction: "M12 2.252A8.014 8.014 0 0117.748 8H12V2.252z",
										},
									]}
									onClick={() => {
										console.log("clicked");
